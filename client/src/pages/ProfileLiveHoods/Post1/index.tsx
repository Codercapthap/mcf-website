                              ...
                              <Box component="div">
                                <Box component="div" 
                                 dangerouslySetInnerHTML={{
                                  __html: `${t("livelihoods.profile.post1.content")}`
                                 }}
                                ></Box>
                    ...
                    <Box component="div" className="profile_details_item">
                      ...
                      >
                        <Link
                          ...
                          rel="author"
                        >
                          <Box component="span">{t("livelihoods.profile.post1.profile_detail.author")}</Box>
                        </Link>
                      </Box>
                    </Box>
                    <Box component="div" className="profile_details_item">
                      ...
                      <Box
                        ...
                        className="profile_details_item_desc"
                      >
                        <Box component="abbr" title={t("livelihoods.profile.post1.profile_detail.date")}>
                      ...
                      >
                        ...
                        >
                          <Link
                            ...
                            rel="category tag"
                          >
                            {t("livelihoods.profile.post1.profile_detail.categories")}
                          </Link>
                        </Box>
                      </Box>
                    </Box>

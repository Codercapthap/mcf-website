  ...
  return (
    <>
      ...
      <Box component="div" id="middle">
        <Box
          component="div"
          className="headline cmsmasters_color_scheme_default"
        >
          <Box
            component="div"
            className="headline_outer cmsmasters_headline_disabled"
          >
        ...
        <Box component="div" className="middle_inner">
          <Box component="div" className="content_wrap fullwidth">
            <Box component="div" className="middle_content">
              <Box
                component="div"
                id="cmsmasters_row_64a3e8e8bee234_87932466"
                className="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed"
              >
                <Box component="div" className="cmsmasters_row_outer_parent">
                  <Box component="div" className="cmsmasters_row_outer">
                    <Box component="div" className="cmsmasters_row_inner">
                      <Box
                        component="div"
                        className="cmsmasters_row_margin cmsmasters_11"
                      >
                        <Box
                          component="div"
              ...
              <Box
                component="div"
                id="cmsmasters_row_64a3e8e8bf1ab0_78745716"
                className="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed"
              >
                <Box component="div" className="cmsmasters_row_outer_parent">
                  <Box component="div" className="cmsmasters_row_outer">
                    <Box component="div" className="cmsmasters_row_inner">
                      <Box component="div" className="cmsmasters_row_margin">
                        <Box
                          component="div"
                          className="cmsmasters_column two_third"
                        >
                          <Box
                            component="div"
                            id="cmsmasters_heading_64a3e8e8bf4be"
                          ...
                          <Box
                            component="div"
                            id="cmsmasters_heading_64a3e8e8bf5bf"
                            className="cmsmasters_heading_wrap cmsmasters_heading_align_left"
                          >
                            <Typography
                              variant="h3"
                          ...
                          <Box
                            component="div"
                            id="cmsmasters_divider_64a3e8e8bf6056_43275592"
                            className="cl"
                          ></Box>
                          <Box
                            component="div"
                            className="cmsmasters_contact_form"
                          >
                            <Box
                              component="div"
                              role="form"
                              className="wpcf7"
                              id="wpcf7-f12038-p12413-o1"
                              dir="ltr"
                            >
                              <Box
                                component="div"
                              ...
                              <Box
                                component="form"
                                action="/lien-he/#wpcf7-f12038-p12413-o1"
                                method="post"
                        ...
                        <Box
                          component="div"
                          className="cmsmasters_column one_third"
                        >
                          <Box
                            component="div"

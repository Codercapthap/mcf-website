    ...
    <>
      ...
      <Box component="div" id="page" className="middle_inner">
                            ...
                            >
                              <Box
                                ...
                                dangerouslySetInnerHTML={{
                                  __html: `${t(
                                    "conservation.profile.post2.content"
                                  )}`,
                                }}
                              ></Box>
                            </Box>
                    ...
                    <Box component="div" className="profile_details_item">
                      ...
                      >
                        <Box
                          component="abbr"
                          title={t(
                            "conservation.profile.post2.profile_detail.date"
                          )}
                        >
        ...
        <Box component="div" className="post_nav">
          ...
          >
            <Link
              to="/project/cap-nhat-chien-luoc-quan-ly-nuoc-de-phuc-hoi-sinh-canh-dat-ngap-nuoc-vuon-quoc-gia-tram-chim-trong-boi-canh-bien-doi-khi-hau-va-phat-trien-o-thuong-nguon"
              rel="next"
